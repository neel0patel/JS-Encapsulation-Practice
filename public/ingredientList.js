const ingredientList = {
  ...
  createIngredientCard: function (ingredient) {
    const ingredientCard = document.createElement("div");
    ingredientCard.className = "card";

    const sandwichHasIngredient = cart.selectedSandwich.ingredients.includes(
      ingredient.name
    );
  ...
  toggleIngredient: function (ingredient) {
    let sandwichHasIngredient = cart.selectedSandwich.ingredients.includes(
      ingredient.name
    );
    if (sandwichHasIngredient) {
      cart.selectedSandwich.ingredients =
        cart.selectedSandwich.ingredients.filter((x) => x !== ingredient.name);
    } else {
